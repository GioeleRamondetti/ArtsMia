...
public class FXMLController {
    ...
    void doAnalizzaOggetti(ActionEvent event) {
    	...
    	txtResult.appendText("verici "+this.model.nVertici()+"\n");
    ...
    void doCalcolaComponenteConnessa(ActionEvent event) {
    	...
    	try {
    		...
    		txtResult.setText("inserire codice");
    		return ;
    	}
    	// controllo che id corrisposta ad un vertice da fare!!!
    	// lo facccio per premdere oggetto
    	ArtObject vertice=this.model.getObject(objectId);
    	if(vertice==null) {
    		txtResult.setText("oggetto inesistente");
    	}
    	
    	int size=this.model.getCompoenteConnessa(vertice);
